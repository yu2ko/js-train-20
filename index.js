...
Car.prototype.accelerate = function (speedAcceleration = 1) {
...
Car.prototype.brake = function (speedBraking = 1) {
  this.speed -= speedBraking;
  console.log(
...
// Додатковий метод specific для прототипу Trucks,
// примає число якщо воно більше towingCapacity виводить рядок в консоль: Навантаження занадто важке для буксирування,
